...
'genres' => $genre,'nowPlaying' => $nowPlaying
    ]);
    }
    ...
    public function show($id)
    {
        ...
        $review =  Http::withToken(config('services.tmdb.token'))
        ->get('https://api.themoviedb.org/3/movie/'.$id.'/reviews')->json()['results'];
        $review = collect($review)->take(5);
