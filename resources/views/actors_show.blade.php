            ...
            <div class="flex-none">
                ...
                <ul class="flex items-center mt-4">
                    ...
                    @if ($social['instagram_id'])
                        <li class="ml-6">
                            <a href="{{'https://twitter.com/'.$social['instagram_id'] }}" title="Instagram">
