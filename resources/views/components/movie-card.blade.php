   <div class="rounded overflow-hidden shadow-lg mt-8">
      <a href="{{route('movies.show',$popularMovie['id'])}}"><img class="w-76 hover:opacity-75 transition ease-out duration-150 " src="{{'https://image.tmdb.org/t/p/w500/'.$popularMovie['poster_path']}}" alt="poster" ></a>
      <div class="px-6 py-4">
...
<a href="{{route('movies.show',$popularMovie['id'])}}" class="text-sm mt-2 hover:text-gray-300">
        ...
        <div class="flex items-center text-gray-400 text-sm">
                        ...
                        <span class="ml-1 text-sm">{{ $popularMovie['vote_average'] }}</span>
