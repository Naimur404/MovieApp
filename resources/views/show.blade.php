...
<div class="movie-cast border-b border-gray-800">
    ...
    @if($loop->index < 9)
    <div class="rounded overflow-hidden shadow-lg mt-8">
      <a href="#"><img class="w-full hover:opacity-75 transition ease-out duration-150" src="{{'https://image.tmdb.org/t/p/w500/'.$image['file_path']}}" alt="Parasite" class="hover:opacity-75 transition ease-in-out duration-150"></a>
