...
<div class="movie-info border-b border-gray-800">
	<div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
		...
		<div class="md:ml-24">
			<h2 class="text-4xl font-semibold">Parasite (2019)
			</h2>
				<div class="flex flex-wrap items-center text-gray-400">
						...
						<span>Action, Thiller, Drama</span>
					</div>
...
<div class="movie-cast border-b border-gray-800">
    ...
    <div class="rounded overflow-hidden shadow-lg mt-8">
      <a href="#"><img class="w-full hover:opacity-75 transition ease-out duration-150 w-66 md:w-96" src="{{asset('img/parasite.jpg')}}" alt="Parasite" ></a>
      <div class="px-6 py-4">
...
<div class="movie-cast border-b border-gray-800">
    ...
    <!--Card 1-->
    <div class="rounded overflow-hidden shadow-lg mt-8">
      <a href="#"><img class="w-full hover:opacity-75 transition ease-out duration-150" src="{{asset('img/parasite.jpg')}}" alt="Parasite" class="hover:opacity-75 transition ease-in-out duration-150"></a>
